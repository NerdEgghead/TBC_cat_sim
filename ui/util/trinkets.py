...
trinket_map = {
    "Bloodlust Brooch": "brooch",
    "Berserker's Call": 'berserkers_call',
    "Slayer's Crest": "slayers",
    "Icon of Unyielding Courage": "icon",
    "Abacus of Violent Odds": "abacus",
    "Kiss of the Spider": "kiss",
    "Badge of Tenacity": "tenacity",
    "Crystalforged Trinket": "crystalforged",
    "Hourglass of the Unraveller": "hourglass",
    "Tsunami Talisman": 'tsunami',
    "Dragonspine Trophy": "dst",
    "Badge of the Swarmguard": "swarmguard",
    "Romulo's Poison Vial": "vial",
    "Living Root of the Wildheart": "wildheart",
    "Ashtongue Talisman of Equilibrium": "ashtongue",
    "Steely Naaru Sliver": "steely_naaru_sliver",
    "Shard of Contempt": "shard_of_contempt",
    "Madness of the Betrayer": "madness",
    "Mark of the Champion": "motc",
    "Drake Fang Talisman": "dft",
    "Alchemist Stone": "alch",
    "Assassin's Alchemist Stone": "assassin_alch",
    "Blackened Naaru Sliver": "bns",
    "Darkmoon Card: Crusade": "crusade"
...
def trinket_friendly_name(name):
    for item in trinket_map.items():
        if item[1] == name:
            return item[0]
    return None